...
var (
	...
	contentLengthJSONHeader = ParameterDescriptor{
		Name:        "Content-Length",
		Type:        "integer",
	...
	contentLengthJSONErrorHeader = ParameterDescriptor{
		Name:        "Content-Length",
		Type:        "integer",
		Description: "Length of the JSON response body.",
		Format:      "<length>",
	...
	authenticationErrorResponseDescriptior = ResponseDescriptor{
		Name:        "Authentication Error",
		StatusCode:  http.StatusUnauthorized,
		Description: "The client is not authenticated.",
		Headers: []ParameterDescriptor{
			authChallengeHeader,
			contentLengthJSONErrorHeader,
		},
		Body: BodyDescriptor{
		...
		ErrorCodes: []errcode.ErrorCode{
			errcode.ErrorCodeUnauthenticated,
		},
	}
	...
	repositoryAccessDeniedResponseDescriptor = ResponseDescriptor{
				...
				Requests: []RequestDescriptor{
					{
						...
						Failures: []ResponseDescriptor{
							...
							authenticationErrorResponseDescriptior,
						},
					},
				},
			},
    ...
    "tags": [
        ...
        ...
						...
						Failures: []ResponseDescriptor{
							...
							repositoryAccessDeniedResponseDescriptor,
						},
					},
					{
						Name:            "Tags Paginated",
